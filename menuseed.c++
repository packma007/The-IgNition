...
namespace domains {
    ...
    namespace {
        ...
        const Spec kSpecs[] = {
            ...
            // 닭 세 가지. 가슴살은 단백질만 높고 다리살과 닭갈비는 지방이 붙는다.
            // 같은 닭이라도 솔버 입장에서는 쓰임새가 다른 재료다.
            { "간장 닭가슴살구이",       "g",    26, false,   50,  300,  10,  0.035, 0.270, 0.025 },
            { "카레 닭가슴살볶음",       "g",    27, false,   50,  300,  10,  0.060, 0.240, 0.050 },
            { "간장 닭다리살구이",       "g",    30, false,   50,  300,  10,  0.040, 0.190, 0.090 },
            { "닭갈비",                 "g",    30, false,   50,  300,  10,  0.090, 0.150, 0.090 },

            // 돼지고기 세 가지.
            { "제육볶음",               "g",    32, false,   50,  300,  10,  0.070, 0.150, 0.130 },
            { "간장 돼지불고기",         "g",    30, false,   50,  300,  10,  0.060, 0.160, 0.110 },
            { "돼지고기 김치볶음",       "g",    28, false,   50,  250,  10,  0.040, 0.130, 0.140 },

            // 두부 두 가지. 고기 없이 단백질을 채울 수 있는 줄이 하나는 있어야 한다.
            { "두부조림",               "g",    14, false,   50,  250,  10,  0.040, 0.095, 0.065 },
            { "두부김치",               "g",    18, false,   50,  250,  10,  0.045, 0.085, 0.080 },

            // 낱개로 파는 유일한 메뉴. 계란말이를 반 줄만 팔 수는 없다.
            // 1줄 = 60g 기준으로 100g 값을 환산해 두었다.
            { "계란말이",               "줄",   2400, true,    1,    1,   0,  1.500, 6.600, 6.600 },

            { "버섯채소볶음",           "g",    16, false,   30,  200,  10,  0.050, 0.030, 0.050 },
        ...
        MenuPtr build(const Spec& s) {
            ...
            // 탄단지를 셋 다 넣는다. 0 에 가까운 것도 빼지 않는다 -
            // 없는 영양소와 0 인 영양소는 다른 말이다. 닭가슴살에 탄수화물이 거의 없는 것은
            // 우리가 안 재본 것이 아니라 정말 그런 것이다.
